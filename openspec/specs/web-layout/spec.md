...
## Purpose
App shell providing navigation, routing, error boundary, and responsive design. Top navigation bar replaces the removed Sidebar.
...
### Requirement: Routing
The system MUST route using TanStack Router for: /, /devices, /events, /dashboards.

(Previously: included /settings)
