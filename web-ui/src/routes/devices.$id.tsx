  ...
  if (isError || !device) {
    return (
      <div className="flex flex-col items-center gap-4 py-16 text-center">
        ...
        <p className="text-lg font-medium text-slate-600">Device not found</p>
        <button
          onClick={() => refetch()}
  ...
  if (isEditing) {
    return (
      <div className="space-y-6">
        ...
        <h1 className="text-2xl font-bold text-slate-900">Edit Device</h1>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-slate-900">Device Detail</h1>
        <div className="flex items-center gap-2">
          <button
            onClick={() => setIsEditing(true)}
            className="rounded-lg px-4 py-2 text-sm font-medium text-indigo-600 transition-all duration-200 hover:bg-indigo-50"
          >
            Edit
          </button>
          <button
            onClick={() => setShowDeleteDialog(true)}
            className="rounded-lg px-4 py-2 text-sm font-medium text-red-600 transition-all duration-200 hover:bg-red-50"
          >
            Delete
          </button>
        </div>
